...
CreateLambdaConvar( "lambdaplayers_musicbox_drawvisualizer", 1, true, true, false, "在音乐盒上方绘制可视化音频特效", 0, 1, { type = "Bool", name = "音频可视化", category = "Music Box" } )
...
CreateLambdaConvar( "lambdaplayers_musicbox_visualizerresolution", 100, true, true, false, "可视化音频特效", 20, 200, { type = "Slider", decimals = 0, name = "音频可视化分辨率", category = "Music Box" } )
