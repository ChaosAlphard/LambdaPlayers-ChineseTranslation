...
CreateLambdaConvar( "lambdaplayers_lambdaadmin_maxadmins", 2, true, false, false, "同时存在的管理员的最大数量限制", 0, 100, { type = "Slider", decimals = 0, name = "最大管理员数量", category = "Admins" } )
CreateLambdaConvar( "lambdaplayers_lambdaadmin_adminchance", 100, true, false, false, "Lambda Player 生成时成为管理员的几率", 0, 100, { type = "Slider", decimals = 0, name = "管理员几率", category = "Admins" } )
